...
- Mac: without internet or an AI model, a single word is now translated by
  Apple's translation instead of not at all.
- Mac: the settings and the flashcard window no longer pull you onto another
...
- Anki's note types show how many notes in the whole deck use them, not at
  most 100.
- Mac: the optional permission is named the way System Settings names it on
