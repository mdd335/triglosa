/* Every language with a two-letter code (ISO 639-1), for a reader naming the
   language of a text the app got wrong. A standard's list, not a choice:
   the names come from the platform's own table, in the reader's language,
   and a code the platform has no name for is left out where it is shown. */
